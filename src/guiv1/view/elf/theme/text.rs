//! Theme for text info containers in the ELF View.
...
pub struct ElfViewTextInfoTheme {
...
impl container::StyleSheet for ElfViewTextInfoTheme {
...
impl core::default::Default for ElfViewTextInfoTheme {
    fn default() -> Self {
