//! Theme for the project create/edit header.
...
pub struct Theme {
    ...
    /// The theme of the Create/Update and Cancel buttons.
...
impl From<Arc<RwLock<GlobalTheme>>> for Theme {
    fn from(theme: Arc<RwLock<GlobalTheme>>) -> Self {
        ...
        // Get the text color.
        match theme.styles.get(&String::from("vdbpr-ph-txtclr")) {
            Some((stylename, _)) => match theme.color.get(stylename) {
                Some(color) => out.textcolor = (*color).into(),
                _ => (),
            },
            _ => (),
        };
        ...
        // Get the text input theme.
        match textinput::Theme::extract(&theme, String::from("vdbpr-ph-txtin")) {
        ...
        match button::Theme::extract(&theme, String::from("vdbpr-ph-btn")) {
...
impl Default for Theme {
    fn default() -> Self {
        // Build the textcolor.
        let textcolor = Color::from([1.0, 1.0, 1.0]);
        ...
        Theme { textcolor, background, textinput, button }
    }
}
